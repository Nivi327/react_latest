      ...
      <section id="about-us" className="about-us">
        <div className="container aos-init aos-animate">
          <div className="row content">
            <div className="col-lg-6 box aos-init aos-animate" data-aos="fade-right" style={{padding:'20px'}}>
              <img
            ...
            <div className="col-lg-6 pt-lg-0 aos-init aos-animate" data-aos="fade-left" style={{ marginTop: '58px' }}>
